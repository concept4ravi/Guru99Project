...
public class VerifyMobileField extends BaseClass{
	
	public VerifyMobileField(WebDriver driver) {
		super(driver);
	...
	public static void mobileFieldTextCharacterCheck() throws Exception {
		AddCustomer_Page.txtbx_Mobile().clear();
		AddCustomer_Page.txtbx_Mobile().click();
